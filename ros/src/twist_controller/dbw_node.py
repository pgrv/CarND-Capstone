...
class DBWNode(object):
    def __init__(self):
        ...
        # TODO: Subscribe to all the topics you need topics
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in (self.current_vel, self.linear_vel, self.angular_vel):
                self.throttle, self.brake, slef.steering = self.controller.control(self.current_vel, self.dbw_enabled, self.linear_vel, self.angular_vel)
            if self.dbw_enabled:
